...
if __name__ == '__main__':
    ...
    for seq_num,frame_nums in max_frames.items():
        print(seq_num)
        input_folder_path = os.path.join("../data/data_tracking_image_2/training/image_02/",seq_num)

        os.makedirs(os.path.join("../data/mask_from_detectron",seq_num), exist_ok=True)
        ...
        for frame_num in range(frame_nums+1):
            ...
            mask=pred.get("pred_masks")[use_instance, :, :].cpu().detach().numpy() 
